...
<head>
    ...
    <title>Add Featured Events</title>
...
@media all and (max-width: 900px) {
  ...
  nav ul li.items:hover:after {
    opacity: 0;
        ...
        .form-group {
            width: 48%; /* Adjusts for 2 columns */
            display: flex;
        ...
        .form-container input[type="submit"] {
            width: 100%;
            padding: 12px;
            background-color: rgb(34, 245, 182);
            color: black;
            border: none;
            border-radius: 5px;
            cursor: pointer;
        ...
        .form-container input[type="submit"]:hover {
            background-color: rgb(30, 220, 160);
        }
...
<main>
    <div class="form-container">
        <h2>Add Featured Events</h2>
        <form method="post" action="submit_featured_event.php">
            <div class="form-row">
